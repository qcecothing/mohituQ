      ...
      <div className="w-full max-w-6xl px-4 md:px-8">
        <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
          <GridItem
            ...
            title="This is quantum bby"
            description="In the bleeding edge of quantum computing."
          />
          ...
          <GridItem
            ...
            title="Another feature yes"
            description="I don't know what to say here. I just want to make it look good."
          />
